...
DEFAULT_POLLINATIONS_CHAT_MODEL = "gemini-3.5-flash"
...
def get_system_prompt() -> str:
    env = load_env_file()
    default = (
        "Sen dogruluk odakli bir Discord asistanisin. "
        "Turkce sorulara Turkce, Ingilizce sorulara Ingilizce cevap ver. "
        "Kisa ve net ol. "
        "Kisi, sporcu, meslek, takim, tarih gibi konularda ASLA uydurma veya karistirma. "
        "Emin degilsen 'Bu konuda emin degilim' de; yanlis bilgi vermektense sus veya uyar."
    )
